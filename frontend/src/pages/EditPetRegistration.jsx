...
import BackButton8 from "../components/BackButton8";
...
const EditPetRegistration = () => {
  ...
  const handleEditPetRegistration = () => {
    const data = {
      petname,
      breed,
      pettype,
    ...
    setLoading(true);
    axios
      .put(`http://localhost:5555/pet/${id}`, data)
      .then(() => {
        setLoading(false);
        enqueueSnackbar(" Pet Registration Edited Successfully", {
          variant: "success",
        });
        navigate("/");
      })
...
    >
    ...
    <div className="p-4">
      <BackButton8 />
      <h1 className="text-3xl my-4">Edit Pet Registration</h1>
      {loading ? <Spinner /> : ""}
      <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
        ...
        <button className="p-2 bg-sky-300 m-8" onClick={handleEditPetRegistration} style={{backgroundColor:'#ffd700'}}>
          Submit
        </button>
      </div>
    </div>
...
export default EditPetRegistration;
